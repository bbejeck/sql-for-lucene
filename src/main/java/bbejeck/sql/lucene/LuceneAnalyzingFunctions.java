...
public interface LuceneAnalyzingFunctions {
     ...
     Function<String, String> removeWhitespace = s -> CharMatcher.whitespace().removeFrom(s);
     Function<String, String> trim = String::trim;
     Function<String, String> lettersNumbers = s -> CharMatcher.javaLetterOrDigit().retainFrom(s);
